...
The best linear model I found is feature of livingArea, centralAir, bathrooms, bedrooms, heating, lotSize, rooms, livingArea* centralAir ,bathrooms * heating, bedrooms* heating, livingArea * rooms, bedrooms * rooms, livingArea * lotSize, lotSize * rooms,centralAir*bedrooms. The RMSE is 64636.96, which is lower than the RMSE in professor's medium regression.
